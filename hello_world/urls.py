...
urlpatterns = [
    ...
    path("application/profile", core_views.profile),
    path("application/aboutus/<uid>", database_views.database_render_aboutus, name="database_render_aboutus"),
    ...
    path("application/home/result/<uid>/<fid>", database_views.database_statistic, name="database_homeShowTest"),
    path("application/files/add/<uid>", database_views.database_item_add,name="database_item_add"),
    path("application/files/<fuid>", database_views.database_item_list_by_id, name="database_item_list_by_id"),
    #path("application/files/s/<fuid>", # specific file)
    path("application/files/update/<fid>", database_views.update_name, name="database_update_name"),
